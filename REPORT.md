...
- **ระบบ** Build Gradle
- **ผู้จัดทำ** 
  - 6833031921 เจมชรันต์ ศรีแก้ว ([tawdces](https://github.com/tawdces))
  - 6833126921 ธีริทธิ์ ตันติโรจนาเมธ ([jiantan555](https://github.com/jiantan555))
  - 6833171021 พงศ์ปณต จันทนา ([munichPMN](https://github.com/munichPMN), [pongp-cu1710-alt](https://github.com/pongp-cu1710-alt))
  - 6833245921 วัชรพัฒน์ ริดำรงค์ ([peteza555](https://github.com/peteza555))
- **ภาพรวม** 
	- โปรแกรมนี้คือเกมต่อสู้แนวแอ็กชัน 2 มิติ แบบ Local Multiplayer ภายใต้ชื่อ Gun Mayhem Arena ผู้เล่นสองคนจะต้องต่อสู้กันบนหน้าจอเดียวกัน โดยใช้ทั้งอาวุธปืนและการโจมตีแบบต่าง ๆ เพื่อสร้างความเสียหายและผลักคู่ต่อสู้ ให้กระเด็นตกจากเวทีเพื่อทำคะแนน 
	-  ระบบเกมถูกออกแบบมาให้มีการแข่งขันเป็นรอบ ผู้เล่นแต่ละคนจะมีจำนวนชีวิตจำกัดในแต่ละรอบ หากใครถูกผลักตกจากเวที จนจำนวนชีวิตหมดก่อนจะเป็นฝ่ายแพ้ในรอบนั้น ผู้ที่ชนะครบ 3 รอบก่อนจะเป็นผู้ชนะในแมตช์นั้น ภายในฉากจะมีการสุ่มดรอปไอเทมเสริมต่าง ๆ ได้แก่ อาวุธปืนชนิดต่าง ๆ กับดัก (กล่องระเบิดและกับระเบิด) และกล่องไอเทมเสริมพลัง (โล่ป้องกัน และเพิ่มความเร็วในการวิ่ง) 
...
.\gradlew.bat run
```
หรือ กรณีต้องการรันด้วย ไฟล์ jar (โปรดติดตั้ง JavaFX)
```powershell
java --enable-native-access=javafx.graphics --module-path "<PATH_TO_FX>/lib" --add-modules javafx.controls,javafx.fxml,javafx.media -jar Project-1.0-SNAPSHOT-with-sources.jar
```
### 2.3 คำสั่งทดสอบ
```powershell
.\gradlew.bat test
...
#### 2.4.2 หน้าเลือกด่าน (Map Select)
...
![Map Select](src/main/resources/screenshots/Map_select.png)
#### 2.4.3 หน้าเลือกอาวุธเริ่มต้น (Weapon Select)
...
![Weapon Select](src/main/resources/screenshots/Weapon_select.png)
#### 2.4.4 หน้าจอการเล่นหลัก (Game Panel)
...
![Game Panel](src/main/resources/screenshots/Game_panel.png)
### 2.5 หลักการเล่นเกม
